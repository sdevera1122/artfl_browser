...
EXAC_FILES_DIRECTORY = '../exac_data_artfl/'#/data/sdeveras/misc/ARTFL_Database/newArtfl_oct2016
ARTFL_FOLDER_NAME = 'artfl_07_2018'

REGION_LIMIT = 1E5
EXON_PADDING = 50
# Load default config and override config from an environment variable
#db_name = artfl4; 4 = batch4
app.config.update(dict(
    ...
    SITES_VCFS=glob.glob(os.path.join(os.path.dirname(__file__), EXAC_FILES_DIRECTORY, ARTFL_FOLDER_NAME,'FINAL_Artfl_with_hist.vcf.gz')),
    ...
    BASE_COVERAGE_FILES=glob.glob(os.path.join(os.path.dirname(__file__), EXAC_FILES_DIRECTORY, ARTFL_FOLDER_NAME, 'sorted.*.cov.txt.gz')),
